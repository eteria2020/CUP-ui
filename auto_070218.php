...
<script type="text/javascript">
   ...
   jQuery("#btnSubmit").click(function() {
    ...
    jQuery("#data").jqGrid({
        url:'auto-data.php',
        datatype: "json",
        colNames:['N','Plate','Batt.', 'Km','v. sw','contact',"KEY","RPM","Spd.","Busy","Ready","Park","Charging","Plug","Battery_Safety","Status"<?php if ( $username=='admin')  echo ',"N.Trips"';?>],
        colModel:[
            {name:'label',index:'label', width:50, align:'center'},
            {name:'plate',index:'plate', width:70, align:'center'},
            {name:'battery',index:'battery', width:50, align:'right'},
            {name:'km',index:'km', width:50, align:'right'},
            {name:'software_version',index:'software_version', width:80, align:'left'},
            {name:'last_contact',index:'last_contact', width:80, align:'right',formatter:'date', formatoptions:{srcformat:"Y-m-d H:i:s",newformat:"d/m/Y   H:i:s"}},
            ...
            {name:'battery_safety',index:'battery_safety', width:40, align:'center',formatter:'checkbox'},
