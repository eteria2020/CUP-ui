...
<html lang="en">
  <head>
    ...
    <title>Cars live location</title>
    ...
    <!-- Live Main CSS -->
	<link rel="stylesheet" type="text/css" href="css/live.main.css" media="screen"/>
	...
	<!-- DatePicker [JS] -->
    <script src="js/libs/bootstrap-datepicker.min.js" type="text/javascript"></script>
	...
	<script type="text/ecmascript" src="js/live.main.min.js"></script>
</body>
</html>
