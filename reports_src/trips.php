...
<html lang="en">
  <head>
    ...
    <title>Global Trips Report</title>
			...
			<div class="col-md-9" role="main">
				...
				<div class="panel panel-default  affix-top" id="data-range">
					<div class="panel-heading">
						Intervallo (Ultimi 28 giorni)</span>
					</div>
					<div class="panel-body">
						<div id="days-chart">
							<span class="reset" style="display: none;"> filtro: <span class="filter"></span></span>
					        	<a class="reset" href="javascript:global.charts.day.filterAll();dc.redrawAll();" style="display: none;"> Azzera </a>
  			    ...
  			    <div class="row" id="bio-data">
        				...
        				<div class="panel panel-default" id="day-of-week">
        					...
        					<div class="panel-body">
        						<div id="day-of-week-chart">
	        						<span class="reset" style="display: none;">filtro: <span class="filter"></span></span>
        					        	<a class="reset" href="javascript:global.charts.dayOfWeek.filterAll();dc.redrawAll();" style="display: none;"> Azzera </a>
        					        <div class="clearfix"></div>
        					    </div>
        					</div>
        				</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="panel panel-default" id="city">
        					<div class="panel-heading">
        					...
        					<div class="panel-body">
        						<div id="city-chart">
        					        <span class="reset" style="display: none;">filtro: <span class="filter"></span></span>
        					        	<a class="reset" href="javascript:global.charts.city.filterAll();dc.redrawAll();" style="display: none;"> Azzera </a>
        					        <div class="clearfix"></div>
        					    </div>
        		            </div>
        				</div>
				...
				<div class="panel panel-default" id="duration">
		            ...
		            <div class="panel-body">
		            	<div id="duration-chart">
		                    <span class="reset" style="display: none;">filtro: <span class="filter"></span></span>
							<a class="reset" href="javascript:global.charts.duration.filterAll();dc.redrawAll();" style="display: none;"> Azzera </a>
					        <div class="clearfix"></div>
					    </div>
					</div>
				</div>
		        ...
		        <div class="panel panel-default" id="beginning-hour">
					...
					<div class="panel-body">
					    <div id="beginning-hour-chart">
					        <span class="reset" style="display: none;">filtro: <span class="filter"></span></span>
					        <a class="reset" href="javascript:global.charts.beginningHour.filterAll();dc.redrawAll();" style="display: none;"> Azzera </a>
					        <div class="clearfix"></div>
					    </div>
					</div>
				</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-6">
                     	<div class="panel panel-default" id="customer-age">
							...
							<div class="panel-body">
							    <div id="age-chart">
							        <span class="reset" style="display: none;">filtro: <span class="filter"></span></span>
							        <a class="reset" href="javascript:global.charts.age.filterAll();dc.redrawAll();" style="display: none;"> Azzera </a>
							        <div class="clearfix"></div>
								</div>
					...
					<div class=" col-xs-12 col-sm-6 col-md-6">
						<div class="panel panel-default" id="customer-gender">
							...
							<div class="panel-body">
							    <div id="gender-chart">
							        <span class="reset" style="display: none;">filtro: <span class="filter"></span></span>
							        <a class="reset" href="javascript:global.charts.gender.filterAll();dc.redrawAll();" style="display: none;"> Azzera </a>
							        <div class="clearfix"></div>
							    </div>
							</div>
						</div>
			...
			<div class="col-md-3" role="complementary">
				<nav class="bs-docs-sidebar hidden-print hidden-xs hidden-sm affix">
					<ul class="nav bs-docs-sidenav"  data-spy="affix" data-offset-top="100" data-offset-bottom="0">
						...
						<li><a href="#city">Suddivisione per Citt&agrave;</a></li>
